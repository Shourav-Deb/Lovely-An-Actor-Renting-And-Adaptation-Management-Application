 ...
 * @author SD
 */
public class DAdmin_JobApplyApplicationList extends javax.swing.JFrame {
     ...
     * @author SD
     */
    public DAdmin_JobApplyApplicationList() {
        Seticon();
        initComponents();
    ...
    private void initComponents() {
        ...
        ja_homeb.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        ja_homeb.setNextFocusableComponent(jButton1);
        ja_homeb.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ja_homebActionPerformed(evt);
            }
        });
        jPanel1.add(ja_homeb, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 120, 30));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 220, 50, 50));

        cover.setIcon(new javax.swing.ImageIcon(getClass().getResource("/thefamilyproject/Images/job interview.jpg"))); // NOI18N
        jPanel1.add(cover, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -110, 1160, 790));

        j_Actor_Table.setBackground(new java.awt.Color(12, 47, 154));
        ...
        j_Actor_Table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "User Name", "Name", "Age", "Email", "NID", "Phone Number", "Request Status"
            }
        ) {
        ...
        j_Actor_Table.setSelectionBackground(new java.awt.Color(124, 165, 231));
        ...
        if (j_Actor_Table.getColumnModel().getColumnCount() > 0) {
            ...
            j_Actor_Table.getColumnModel().getColumn(0).setPreferredWidth(80);
            j_Actor_Table.getColumnModel().getColumn(1).setResizable(false);
            j_Actor_Table.getColumnModel().getColumn(1).setPreferredWidth(160);
            j_Actor_Table.getColumnModel().getColumn(2).setResizable(false);
            j_Actor_Table.getColumnModel().getColumn(2).setPreferredWidth(40);
            j_Actor_Table.getColumnModel().getColumn(3).setResizable(false);
            j_Actor_Table.getColumnModel().getColumn(4).setResizable(false);
            j_Actor_Table.getColumnModel().getColumn(4).setPreferredWidth(100);
            j_Actor_Table.getColumnModel().getColumn(5).setResizable(false);
            j_Actor_Table.getColumnModel().getColumn(5).setPreferredWidth(100);
            j_Actor_Table.getColumnModel().getColumn(6).setResizable(false);
            j_Actor_Table.getColumnModel().getColumn(6).setPreferredWidth(50);
        }
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/thefamilyproject/Images/job 2.png"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 70, 350, 160));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/thefamilyproject/Images/job.jpg"))); // NOI18N
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-80, -150, 1140, 610));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        File filehc = new File("C:\\TheFamilyProject\\src\\thefamilyproject\\TextFiles\\NewJobReg.txt");
        try {
...
//          Colum Size Resize                                                                                                                                                                                                                                                   Copyright © 2022 by Shourav Dev. All Rights Reserved.

            j_Actor_Table.getColumnModel().getColumn(0).setPreferredWidth(80);
            j_Actor_Table.getColumnModel().getColumn(1).setPreferredWidth(150);

            j_Actor_Table.getColumnModel().getColumn(2).setPreferredWidth(20);
            j_Actor_Table.getColumnModel().getColumn(3).setPreferredWidth(140);
            j_Actor_Table.getColumnModel().getColumn(4).setPreferredWidth(100);
            j_Actor_Table.getColumnModel().getColumn(5).setPreferredWidth(80);
            j_Actor_Table.getColumnModel().getColumn(6).setPreferredWidth(50);
            jButton1.setVisible(false);
        } catch (Exception ex) {
            Logger.getLogger(DAdmin_JobApplyApplicationList.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void j_Actor_TableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_j_Actor_TableMouseClicked
        try {
            ...
            String available_set = model.getValueAt(selectrow, 6).toString();
        ...
        try {
            ...
            DefaultTableModel model = (DefaultTableModel) j_Actor_Table.getModel();
            int selectrow = j_Actor_Table.getSelectedRow();
            String u_name = model.getValueAt(selectrow, 0).toString();
    ...
    private void j_Radio_AvailableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_j_Radio_AvailableActionPerformed
        try {
            ...
            if (i >= 0) {
                ...
                model.setValueAt(available, i, 6);
                try {
                    File file = new File("C:\\TheFamilyProject\\src\\thefamilyproject\\TextFiles\\NewJobReg.txt");
                    file.delete();
                    file.createNewFile();
                    FileWriter fw = new FileWriter(file);
                    BufferedWriter bw = new BufferedWriter(fw);
                    bw.write("User Name\tName\tAge\tEmail\tNID\tPhone Number\tRequest Status\n");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new DAdmin_JobApplyApplicationList().setVisible(true);
        });
    }
