 ...
 * @author SD
 */
public class DUser_OrderActor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font("Swis721 BlkEx BT", 3, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Reservation");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 170, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/thefamilyproject/Images/hirebg1.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 320, 140));
        ...
        ja_name.setText("Actor ID No:");
        getContentPane().add(ja_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 400, 140, 30));
        ...
        getContentPane().add(ja_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 400, 170, 30));
        ...
        getContentPane().add(ja_age, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 190, 440, 30));
        ...
        getContentPane().add(ja_nid, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 300, 150, 30));

        ja_nidf.addActionListener(new java.awt.event.ActionListener() {
        ...
        getContentPane().add(ja_nidf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 300, 250, 30));
        ...
        getContentPane().add(ja_mail, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 250, 140, 30));
        ...
        getContentPane().add(ja_mailf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 250, 250, 30));
        ...
        ja_pn2.setText("Total Days:");
        getContentPane().add(ja_pn2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 450, 130, 30));
        ...
        getContentPane().add(ja_dayf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 350, 170, 30));
        ...
        ja_submitb1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        getContentPane().add(ja_submitb1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 610, 130, 50));

        ja_submitb2.setBackground(new java.awt.Color(34, 83, 160));
        ...
        ja_submitb2.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        getContentPane().add(ja_submitb2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 610, 130, 50));

        ja_submitb3.setBackground(new java.awt.Color(33, 94, 94));
        ...
        ja_submitb3.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        getContentPane().add(ja_submitb3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 610, 130, 50));
        ...
        getContentPane().add(jSlider1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 450, 230, -1));
        ...
        getContentPane().add(ja_pnf1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 460, 30, 30));
        ...
        getContentPane().add(ja_pn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 350, 180, 30));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 540, 190, 30));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 510, 450, 40));

        JA_BI.setIcon(new javax.swing.ImageIcon(getClass().getResource("/thefamilyproject/Images/bgos2.png"))); // NOI18N
        ...
        getContentPane().add(JA_BI, new org.netbeans.lib.awtextra.AbsoluteConstraints(-40, 0, 540, 700));
    ...
    private void ja_submitb2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ja_submitb2ActionPerformed
        try {
            ...
            if (name.equals("") && mail.equals("") && nid.equals("") && phone.equals("") && day.equals("")) {
                ...
                jLabel5.setText("             Use The Actor ID Number From The List!");
                ja_id.requestFocus();
            } else if (vermem2(name) == 0) {
                jLabel5.setText("               This Actor Is Currently Not Available.");
                ja_id.requestFocus();
            } else if (Integer.parseInt(day) < 1) {
                jLabel5.setText("               That's A Less Amount Of Time To Spend.");
                jSlider1.requestFocus();
            } else {
                int number = Integer.parseInt(day);
                int fee = number * 1000;
                JOptionPane.showMessageDialog(this, "Please Pay " + fee + " Tk Through Bkash Number 019789467 & Give The Transaction Number.", "Payment", JOptionPane.PLAIN_MESSAGE, icon);
                jLabel5.setText("");
            ...
            while (scan1.hasNext()) {
                ...
                if (value[0].equals(txid_num)) {
                    try {
                        ...
                        FileWriter Write = new FileWriter("C:\\TheFamilyProject\\src\\thefamilyproject\\TextFiles\\NewActorOrder.txt", true);
                        Write.write(name + "\t" + u_name + "\t" + nid + "\t" + mail + "\t" + phone + "\t" + day + "\t" + txid_num + "\t.....\t");
                        Write.write(System.getProperty("line.separator"));
                        Write.close();
                        jTextField1.setText(" Payment Done");
                        JOptionPane.showMessageDialog(this, "After Verifing Info You Will Be Contacted. For More Look At Booking Rules.", "Reservation Request Complete", JOptionPane.PLAIN_MESSAGE, icon2);
                        setVisible(false);
                        DUser_ActorList menu = new DUser_ActorList();
                        menu.Click();
                        menu.show();
    ...
    private void ja_idFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_ja_idFocusLost
        ImageIcon ii = new ImageIcon("C:\\TheFamilyProject\\src\\thefamilyproject\\Images\\Admin\\ActorList\\" + ja_id.getText() + ".jpg");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DUser_OrderActor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DUser_OrderActor().setVisible(true);
            }
        });
    }
