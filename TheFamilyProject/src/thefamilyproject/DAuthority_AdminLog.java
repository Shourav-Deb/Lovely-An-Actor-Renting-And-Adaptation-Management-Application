 ...
 * @author SD
 */
public class DAuthority_AdminLog extends javax.swing.JFrame {

    /**
     *
     * @author SD
     */
    public DAuthority_AdminLog() {
        initComponents();
        Seticon();
    ...
    private void initComponents() {
        ...
        AdminLog.setText("Admin Log Detail");
        AdminLog.setNextFocusableComponent(jButton1);
        getContentPane().add(AdminLog, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 20, 320, 130));
        ...
        jButton2.setBackground(new java.awt.Color(28, 40, 46));
        ...
        jTextField2.setBackground(new java.awt.Color(28, 40, 46));
        ...
        jTextField4.setBackground(new java.awt.Color(28, 40, 46));
        ...
        jTable.setBackground(new java.awt.Color(109, 109, 166));
        ...
        jTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Employee ID", "Password", "Employee Name", "Current Position"
            }
        ) {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/thefamilyproject/Images/adminlog.jpg"))); // NOI18N
            ...
            if (row >= 0) {
                ...
                if (response == JOptionPane.YES_OPTION) {
                    ...
                    try ( FileWriter fw = new FileWriter(file)) {
                        ...
                        bw.write("Employee ID\tPassword\tEmployee Name\tCurrent Position\n");
    ...
    private void jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonActionPerformed
        ...
        if (data.equals("") || pass.equals("") || name.equals("") || position.equals("") || data.equals("                                    ID") || pass.equals("                             Password") || name.equals("                                 Name") || position.equals("                   Position")) {
            ...
            JOptionPane.showMessageDialog(null, "Employee Already Listed!", "Duplicate Found", JOptionPane.ERROR_MESSAGE);
        } else {
            try {

                FileWriter Write = new FileWriter("C:\\TheFamilyProject\\src\\thefamilyproject\\TextFiles\\AdminLog.txt", true);
    ...
    private void outputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_outputActionPerformed
        ...
        try {
            File filehc = new File("C:\\TheFamilyProject\\src\\thefamilyproject\\TextFiles\\AdminLog.txt");
    ...
    private void jTextField2FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField2FocusGained
        jTextField2.setText("");    }//GEN-LAST:event_jTextField2FocusGained

    private void jTextField3FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField3FocusGained
        jTextField3.setText("");    }//GEN-LAST:event_jTextField3FocusGained

    private void jTextField4FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField4FocusGained
        jTextField4.setText("");    }//GEN-LAST:event_jTextField4FocusGained
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new DAuthority_AdminLog().setVisible(true);
        });
    }
