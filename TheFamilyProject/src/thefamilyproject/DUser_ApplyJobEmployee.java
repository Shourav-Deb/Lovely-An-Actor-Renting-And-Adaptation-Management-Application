 ...
 * @author SD
 */
public class DUser_ApplyJobEmployee extends javax.swing.JFrame {

    ImageIcon icon1;

    public DUser_ApplyJobEmployee() {
        initComponents();
        Seticon();
        nameloginfo();
    ...
    private void initComponents() {
        ...
        getContentPane().add(ja_logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 30, 150, 150));
        ...
        getContentPane().add(ja_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 250, 80, 30));
        ...
        getContentPane().add(ja_namef, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 250, 220, 30));
        ...
        ja_age.setText("Age:");
        getContentPane().add(ja_age, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 300, 80, 30));
        ...
        getContentPane().add(ja_agef, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 300, 220, 30));
        ...
        getContentPane().add(ja_nid, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 400, 150, 30));
        ...
        getContentPane().add(ja_nidf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 400, 220, 30));
        ...
        getContentPane().add(ja_mail, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 350, 80, 30));

        ja_mailf.setFont(new java.awt.Font("Segoe UI Black", 1, 12)); // NOI18N
        ja_mailf.setEnabled(false);
        getContentPane().add(ja_mailf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 350, 220, 30));
        ...
        ja_submitb.setBackground(new java.awt.Color(191, 191, 51));
        ...
        ja_submitb.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ked(evt);
            }
        });
        ...
        ja_homeb.setBackground(new java.awt.Color(12, 122, 125));
        ...
        getContentPane().add(ja_homeb, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 100, 30));
        ...
        JA_BI.setIcon(new javax.swing.ImageIcon(getClass().getResource("/thefamilyproject/Images/JobApplyBackground.png"))); // NOI18N
        ...
        getContentPane().add(ja_namef1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 220, 220, 30));
    ...
    private void ja_submitbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ja_submitbActionPerformed
        ...
        if (name.equals("") && age.equals("") && nid.equals("") && mail.equals("") && phone.equals("")) {
            ...
            try {
                ...
                FileWriter Write = new FileWriter("C:\\TheFamilyProject\\src\\thefamilyproject\\TextFiles\\NewJobReg.txt", true);
                Write.write(u_name + "\t" + name + "\t" + age + "\t" + mail + "\t" + nid + "\t" + phone + "\t.....\t");
                Write.write(System.getProperty("line.separator"));
                Write.close();

                JOptionPane.showMessageDialog(this, "Tell Us Your Interest For Working With Us.\nAlso Don't Forget To Mail Your C.V. At job@lovely.com.", "Request Completed !!", JOptionPane.PLAIN_MESSAGE, icon);
                setVisible(false);
    ...
    private void ked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DUser_ApplyJobEmployee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DUser_ApplyJobEmployee().setVisible(true);
            }
        });
    }
