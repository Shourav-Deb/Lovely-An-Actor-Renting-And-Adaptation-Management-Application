 ...
 * @author SD
 */
public class DAdmin_ActorJoiningRequestList extends javax.swing.JFrame {
     ...
     * @author SD
     */
    public DAdmin_ActorJoiningRequestList() {
        Seticon();
        initComponents();
    ...
    private void initComponents() {
        ...
        ja_homeb.setBackground(new java.awt.Color(120, 173, 205));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 500, 150, 80));

        cover.setIcon(new javax.swing.ImageIcon(getClass().getResource("/thefamilyproject/Images/actor1.jpg"))); // NOI18N
        cover.setText("jLabel2");
        jPanel1.add(cover, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, -40, 1140, 790));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/thefamilyproject/Images/actor.jpg"))); // NOI18N
        jLabel2.setText("jLabel2");
        jLabel2.setNextFocusableComponent(ja_homeb);
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -30, 1140, 610));

        j_Label_Image.setCursor(new java.awt.Cursor(java.awt.Cursor.CROSSHAIR_CURSOR));
        j_Label_Image.setName(""); // NOI18N
        j_Label_Image.setOpaque(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        File filehc = new File("C:\\TheFamilyProject\\src\\thefamilyproject\\TextFiles\\NewActorReq.txt");
        try {
            ...
            Logger.getLogger(DAdmin_ActorJoiningRequestList.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void j_Radio_AvailableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_j_Radio_AvailableActionPerformed
        try {
            ...
            if (i >= 0) {
                ...
                try {
                    File file = new File("C:\\TheFamilyProject\\src\\thefamilyproject\\TextFiles\\NewActorReq.txt");
                    file.delete();
                    file.createNewFile();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new DAdmin_ActorJoiningRequestList().setVisible(true);
        });
    }
